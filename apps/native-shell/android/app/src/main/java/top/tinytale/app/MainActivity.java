...
public class MainActivity extends BridgeActivity implements ModifiedMainActivityForSocialLoginPlugin {
    ...
    private Intent normalizeNotificationIntent(Intent intent) {
        ...
        String url = firstNonBlank(
            intent.getStringExtra(EXTRA_DEBUG_PUSH_URL),
            getFirstMatchingExtra(intent, URL_EXTRA_KEYS)
        );
        String route = firstNonBlank(
            intent.getStringExtra(EXTRA_DEBUG_PUSH_ROUTE),
            getFirstMatchingExtra(intent, ROUTE_EXTRA_KEYS)
        );
    ...
    protected void onCreate(Bundle savedInstanceState) {
        registerPlugin(DebugPushPlugin.class);
    ...
    protected void onNewIntent(Intent intent) {
        ...
        DebugPushPlugin.captureDebugPushIntent(nextIntent);
    }
